...
pub struct ScheduledTaskBuilder {
    ...
    network: String,
    schedule: String,
    check_condition: Option<CheckCondition>,
    target_function: Option<TargetFunction>,
    gas_config: Option<TaskGasConfig>,
}
...
impl ScheduledTaskBuilder {
    ...
    pub fn with_property_condition(
        ...
        self.check_condition = Some(CheckCondition::Property {
    ...
    pub fn with_function_condition(
        ...
        self.check_condition = Some(CheckCondition::Function {
            contract_address: contract_address.into(),
    ...
    pub fn with_target_function(
        ...
        self.target_function = Some(TargetFunction {
            contract_address: contract_address.into(),
            function: function.into(),
            parameters: Vec::new(),
        });
    ...
    /// Set the gas configuration
    pub fn with_gas_config(mut self, config: TaskGasConfig) -> Self {
    ...
    pub fn with_gas_settings(
        ...
        self.gas_config = Some(TaskGasConfig {
            gas_limit,
            max_gas_price_gwei,
            priority_fee_gwei,
        });
